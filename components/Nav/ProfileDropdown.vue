  ...
  <div class="relative ml-3">
    <div>
      ...
      >
        ...
        <span class="hidden ml-3 text-sm font-medium text-gray-700 lg:block"><span class="sr-only">Open user menu for </span>{{ userName }}</span>
...
export default {
  ...
  computed: {
    ...
    userDetails () {
      return this.userInfo.user_details
    },
    userName () {
      return `${this.userDetails.name} ${this.userDetails.surnames}`
    }
  },
  beforeMount () {
